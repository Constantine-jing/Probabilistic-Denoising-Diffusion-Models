---
title: 'Instructor Notes: Tutorial & Homework Overview'
author: "Mengyan Jing"
date: "2026-02-18"
output: pdf_document
---
...
**(a) Why predict noise instead of clean image x0? (4 pts)**

Expected key points (any 2 of these gets full marks):
- noise always comes from N(0,I) — consistent target regardless of image/timestep
- Given predicted noise, can algebraically recover original x0
...
Expected key points:
- Learn map any noisy point directly to clean data
- Self-consistency property: same trajectory to same output
